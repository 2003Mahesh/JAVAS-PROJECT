	...
	public Application() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					total_meal = ((double) (spinner.getValue()) * pmr) + ((double) (spinner_1.getValue()) * pcr)
							+ ((double) (spinner_2.getValue()) * pmc) + ((double) (spinner_3.getValue()) * pbr)
							+ ((double) (spinner_4.getValue()) * pcl);
					total_drink = ((double) (spinner_5.getValue()) * pl) + ((double) (spinner_1_1.getValue()) * pcd)
							+ ((double) (spinner_2_1.getValue()) * pcoldc) + ((double) (spinner_3_1.getValue()) * photc)
							+ ((double) (spinner_4_1.getValue()) * ps);
		...
		btnReciept.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				textArea.setText("  Kitchen ETTE  ====================                 Meals Total:-  " + total_meal
						+ "                 Drinks Total:- " + total_drink + "                  GST:-          " + x
						+ "                       Total Bill:-   " + bill);
			}
		});
		...
		btnReset.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textField_3.setText("");
				textArea.setText(
						"  Kitchen ETTE  ==================== Meals : -        Manchurian Rice  60 Chic. Fried Rice 100 Manchurian Chow. 80 Chicken Lollipop 200 Chicken Biryani  120 Drinks : -      Lassi            30  Cold Drink       20  Cold Coffee      40  Hot Coffee       20  Shakes           40              +18% GST");
			}
		});
